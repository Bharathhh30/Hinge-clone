...
insert into "public"."sexuality" ("id", "name") values
  (1, 'Straight'),
  (2, 'Gay'),
  (3, 'Lesbian'),
  (4, 'Bisexual'),
...
insert into "public"."zodiac_sign" ("id", "name") values
  (1, 'Aries'),
  (2, 'Taurus'),
  (3, 'Gemini'),
  (4, 'Cancer'),
...
insert into "public"."profiles" ("id", "first_name", "last_name", "dob", "height_cm", "neighbourhood", "latitude", "longitude", "children_id", "covid_vaccine_id", "family_plan_id", "gender_id", "zodiac_sign_id", "sexuality_id", "max_distance_km", "min_age", "max_age", "phone") values
